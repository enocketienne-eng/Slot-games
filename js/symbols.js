// Symbol definitions — colors and shapes from UX design spec (LUC-4 §10)
const SYMBOLS = {
  WILD:       { id: 'wild',       label: 'Wild',      tier: 1, color: '#C0392B', shape: 'star',      weight: 2 },
  SCATTER:    { id: 'scatter',    label: 'Scatter',   tier: 1, color: '#3498DB', shape: 'diamond',   weight: 2 },
  GOLD_BAR:   { id: 'gold_bar',   label: 'Gold Bar',  tier: 1, color: '#F5C518', shape: 'rect',      weight: 4 },
  GOLD_NUGGET:{ id: 'gold_nugget',label: 'Nugget',    tier: 2, color: '#E67E22', shape: 'circle',    weight: 6 },
  PICKAXE:    { id: 'pickaxe',    label: 'Pickaxe',   tier: 2, color: '#7F8C8D', shape: 'cross',     weight: 8 },
  HORSESHOE:  { id: 'horseshoe',  label: 'Horseshoe', tier: 2, color: '#2C3E50', shape: 'horseshoe', weight: 8 },
  COWBOY_HAT: { id: 'cowboy_hat', label: 'Cowboy Hat',tier: 3, color: '#8B4513', shape: 'hat',       weight: 10 },
  TNT_CRATE:  { id: 'tnt_crate',  label: 'TNT',       tier: 3, color: '#E74C3C', shape: 'square',    weight: 10 },
};
